...
This will create a private repo in the STA702-F22 organization on Github with your github user name. Note: You may receive an email invitation to join STA702-F22 on your behalf; please link your github account.
...
You MUST submit both your final `.Rnw` and `.pdf` files to the repo on Github and upload the pdf to [Gradescope](https://www.gradescope.com/courses/585736). 
