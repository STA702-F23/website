...
You MUST submit both your .Rnw and .pdf files to the course site on [Gradescope](https://www.gradescope.com/courses/585736).  Make sure to knit to pdf and  to submit under the right assignment entry.   For this first lab you do not have to submit, just practice!
...
1. Go to Github classroom to create a repository for this assignment  at [lab0](https://classroom.github.com/classrooms/139913329-duke-statsci-sta-702-fall-2023)
This will create a private repo in the STA702-F22 organization on Github with your github user name. Note: You may receive an email invitation to join STA702-F23 on your behalf.  Please link your github user name to your profile.
