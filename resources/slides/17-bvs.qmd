...
- consistency of mixtures of g-priors 
...
- desire that posterior probability of model goes to 1 as $n \to \infty$
     ...
     - need prior on $g$ to depend on $n$ 
     - asymptotically BMA collapses to the true model

- other quantities may converge i.e.  posterior mean 

- what if the true model is not in $\Gamma$?   What can we say?

    - $\M$-closed; BMA converges to the model that is "closest" to the truth in Kullback-Leibler divergence
    - $\M$-complete
    - $\M$-open
