...
- Expected Fisher Information for $\b$ is $\phi \X^T\X$ based on a sample of $n$
  observations 

- ``average information'' in one observation is  $\phi \X^T\X /n$ 
- center prior at MLE and base covariance on the inverse Information in
  ``1'' observation 
-  Posterior mean
...
- Advantages:
    ...
    - Asymtoptically equivalent to MLE
